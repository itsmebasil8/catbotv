...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to catbot voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional catbot features. Turn your account into a ai chatbot!'
    already_on = 'catbot artificial intelligence is already fully functional.'
    already_off = 'catbot artificial intelligence is currently running semi-functional.'
    succ_on = 'catbot Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'catbot Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'AZ') {
